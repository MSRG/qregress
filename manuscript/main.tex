...
\cite{rupp_fast_2012}
\cite{rogers_extended-connectivity_2010}

The first chemical dataset we explore is the BSE49 dataset which consists of homolytic bond cleavages, such as \ce{A-B -> A^{.} + B^{.}}, of X molecules with 49 unique bond types.
