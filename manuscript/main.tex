...
Python
Pennylane\cite{bergholm_pennylane_2022}
Pennylane Qiskit\cite{javadi-abhari_quantum_2024}
Pennylane Qulacs\cite{suzuki_qulacs_2021}
Qiskit\cite{javadi-abhari_quantum_2024}
SciPy Minimize \cite{virtanen_scipy_2020}
...
TREX \cite{van_den_berg_model-free_2022}
