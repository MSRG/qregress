...
Across all three five qubit function fitting datasets, on average, the best encoders are `M-A2-CZ' with an average R$^{2}$ of 0.4599 and ansatz is `Full-CRX' with an average R$^{2}$ of 0.6731.
...
Across all three five qubit function fitting datasets, on average, the best encoders are `IQP' with an average R$^{2}$ of 0.4506 and ansatz is `Full-Pauli-CRZ' with an average R$^{2}$ of 0.4393.
