...
Next, we use learning curves, where the number of training points is varied, while the number of training points is varied to explore claims that PQCs offer better model performance using fewer training points and hyperparameters.\cite{schuld_circuit-centric_2020,du_expressive_2020,suzuki_predicting_2020}
