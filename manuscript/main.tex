...
The first quantum chemistry dataset we explore is BSE49, which contains bond seperation energies (BSEs), for homolytic bond cleavage of covalently bonded molecules, such as \ce{A-B -> A^{.} + B^{.}}.\cite{prasad_bse49_2021}
