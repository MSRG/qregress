...
IQP\_Full-Pauli-CRZ (linear function fitting)
state vector: train 0.99/test 0.99
TREX: train 0.98/test 0.98
without: train 0.98/test 0.98
\ref{fig:linear_error_mitigation}

IQP\_Full-Pauli-CRX (quadratic function fitting)
state vector: train 0.80/test 0.68
TREX: train 0.69/test 0.60
without: train 0.65/test 0.45
\ref{fig:quadratic_error_mitigation}

A2\_HWE-CZ (sine function fitting)
state vector: train 0.92/test 0.96
TREX: train 0.87/test 0.89
without: train 0.87/test 0.91
\ref{fig:sine_error_mitigation}
