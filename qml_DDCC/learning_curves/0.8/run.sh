...
#! /bin/bash
#SBATCH -t 0-23:59:59
#SBATCH -J ${errorname}_0.8_5_DDCC_${name}
#SBATCH -N 1
#SBATCH -n 80
...
/scinet/niagara/software/2019b/opt/base/python/3.11.5/bin/python ${cwd}/main.py --save_path ${path}  --settings ${path}/${name}.json --train_set ${cwd}/0.8_5_DDCC_train.bin --test_set ${cwd}/0.8_5_DDCC_test.bin --scaler ${cwd}/0.8_5_DDCC_scaler.bin --resume_file ${path}/partial_state_model.bin > ${name}.out 2>&1
