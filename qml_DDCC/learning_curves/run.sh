...
#! /bin/bash
#SBATCH -t 0-23:59:59
#SBATCH -J ${errorname}_5_DDCC_${name}
#SBATCH -N 1
#SBATCH -n 80
...
/gpfs/fs1/home/j/jacobsen/gjones/QML/bin/python ${cwd}/main.py --save_path ${path}  --settings ${path}/${name}.json --train_set ${cwd}/${errorname}_5_DDCC_train.bin --test_set ${cwd}/5_DDCC_test.bin --scaler ${cwd}/5_DDCC_scaler.bin > ${name}.out 2>&1
