...
RUN . /opt/miniconda/bin/activate && conda install -y python=3.12 --yes && python3 -m pip install click joblib matplotlib mitiq mthree numpy pandas PennyLane pennylane-qiskit scikit_learn scipy qulacs pennylane-qulacs ply
