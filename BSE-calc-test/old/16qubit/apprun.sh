...
#! /bin/bash
#SBATCH -t 7-00:00:00
#SBATCH -J ${errorname}_PCA16_${name}
#SBATCH -N 1
#SBATCH -n 36
...
apptainer run -C -B ${cwd} /home/gjones/projects/def-jacobsen/gjones/deb.sif /opt/miniconda/bin/python ${cwd}/main.py --save_path ${path}  --settings ${path}/${name}.json --train_set ${cwd}/PCA16_Morgan_train.bin --test_set ${cwd}/PCA16_Morgan_test.bin --scaler ${cwd}/PCA16_Morgan_scaler.bin --resume_file ${path}/final_state_model.bin  > ${name}.out 2>&1
