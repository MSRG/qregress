...
cd $(pwd)/$name
/scinet/niagara/software/2019b/opt/base/python/3.11.5/bin/python ${cwd}/main.py --save_path ${path}  --settings ${path}/${name}.json --train_set ${cwd}/PCA16_0.8_Morgan_train.bin --test_set ${cwd}/PCA16_0.8_Morgan_test.bin --scaler ${cwd}/PCA16_0.8_Morgan_scaler.bin > ${name}.out 2>&1
