...
for i in */; do
    ...
    path="/home/gjones/scratch/lin16qubit/${name}"
...
apptainer run -C -B /home/gjones/scratch/lin16qubit ~/deb.sif /opt/miniconda/bin/python /home/gjones/scratch/lin16qubit/main.py --save_path ${path}  --settings ${path}/${name}.json --train_set /linear_train.bin --test_set /linear_test.bin --scaler /linear_scaler.bin >> ${name}.out 2>&1 
