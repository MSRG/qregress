...
for i in */; do
    ...
    path="/home/gjones/scratch/5RUD_5AL/linear/0.7/${name}"
    echo ${path}
...
apptainer run -C -B /home/gjones/scratch/5RUD_5AL/linear/0.7 /home/gjones/projects/def-jacobsen/gjones/deb.sif /opt/miniconda/bin/python /home/gjones/scratch/5RUD_5AL/linear/0.7/main.py --save_path ${path}  --settings ${path}/${name}.json --train_set /home/gjones/scratch/5RUD_5AL/linear/0.7/linear_train.bin --test_set /home/gjones/scratch/5RUD_5AL/linear/0.7/linear_test.bin --scaler /home/gjones/scratch/5RUD_5AL/linear/0.7/linear_scaler.bin >> ${name}.out 2>&1 
